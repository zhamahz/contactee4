 ...
 */
class StudentRegistration4 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_uni_accepted_1' => 'Статус заявления 1',
            'id_uni_accepted_2' => 'Статус заявления 2',
            'id_uni_accepted_3' => 'Статус заявления 3',
            'id_uni_accepted_4' => 'Статус заявления 4',
            'id_uni_accepted_5' => 'Статус заявления 5',
            'visa' => 'Номер визы',
            'datetime_visa' => 'Дата',
